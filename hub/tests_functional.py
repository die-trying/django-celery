...
class SlotTestCase(ClientTestCase):
    """
    Getting timeslots test — by lesson type, any teacher, etc
    """
    def setUp(self):
    ...
    def test_404(self):
        response = self.c.get('/hub/2032-05-03/type/100500/teachers.json')
    ...
    def test_filter_by_lesson_type(self):
        ...
        response = self.c.get('/hub/2032-05-06/type/%d/teachers.json' % master_class_type.pk)
