...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='class',
            name='subscription',
            field=models.ForeignKey(to='hub.Subscription', related_name='classes', null=True),
        ),
