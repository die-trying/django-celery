...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0002_simplesubscription'),
    ]
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name='tier',
            unique_together=set([('country', 'product_id', 'product_type', 'is_default')]),
        ),
    ]
