...
def create_single_lesson_product(apps, schema_editor):
    ContentType = apps.get_model('contenttypes.ContentType')
    SingleLessonProduct = apps.get_model('products.SingleLessonProduct')
    OrdinaryLesson = apps.get_model('lessons.OrdinaryLesson')

    single_lesson_product = SingleLessonProduct(
        lesson_type=ContentType.objects.get_for_model(OrdinaryLesson),
    )

    single_lesson_product.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0004_auto_20161011_1305'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', djmoney.models.fields.MoneyField(default=Decimal('0.0'), decimal_places=2, max_digits=10, default_currency='USD')),
        ...
        migrations.RunPython(create_single_lesson_product),
    ]
